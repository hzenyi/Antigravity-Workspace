...
- **提案位置與標準格式規範**：
  - **一律加在整份文件最後面**：處內各組若有討論提案，**一律加在整份文件最後面**（緊接於五組宣導資料之後），章節抬頭為 `※教務處討論提案：`。
  - **提案標準格式**：嚴格遵循以下體例，「說　明：」與「決　議：」字詞中間**強制使用全形空格（`　`）**，案由抬頭直接整合請示語（如：提請 審議）：
    ```text
    提案一：[案由抬頭，如：修正「本校學生在校學習評量補充規定」部分條文案，提請 審議。]
    說　明：
    一、...
    二、...
    決　議：
    ```
  - **規章修正案對照表**：若提案涉及法規或要點修正，修訂前後對照表緊接於該案「說　明：」分項之後。
  - **無提案處理**：若五組均無提案，則整份文件維持純宣導資料，省略最後提案區塊。
